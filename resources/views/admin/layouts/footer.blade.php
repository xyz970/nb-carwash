            ...
            $.ajax({
                ...
                error: function(res,xhr){
                    ...
                    $('#insertProfit').submit(function(e){
                        ...
                        var insertUrl = "{{route('admin.profit.insertProfit',':id')}}";
                        $.ajax({
                            ...
                            success: (data) => {
                                ...
                                var oTable = $('#profitTable').dataTable();
                            oTable.fnDraw(false);
                            swal("Success", "Keuntungan berhasil didata", "success");
                            // $("#btn-save").html('Submit');
                            // $("#btn-save"). attr("disabled", false);
                            },
                            error: function(data){
                                swal("Gagal", "Data dengan waktu siang atau pagi telah ada, mohon cek terlebih dahulu", "error");
                            }
                        });
                    })
                }
    ...
    function loadProfitTable(date) {
        ...
        $('#profitTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'daytime',name: 'daytime'},
                    {data: 'for_cash',name: 'for_cash'},
                    {data: 'for_employee',name: 'for_employee'},
                    {data: 'for_owner',name: 'for_owner'},
                ],
                footerCallback: function (row, data, start, end, display) {
            var api = this.api();
    ...
    function loadTransactionTable(){
            ...
            $('#transactionTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'merk_model',name: 'merk_model'},
                    {data: 'type',name: 'type'},
                    {data: 'wash_type.name',name: 'wash_type.name'},
                    {data: 'total',name: 'total'},
                    {data: 'time',name: 'time'},
                    {data: 'date',name: 'date'},
        ...
        $.ajax({
            ...
            error: function(data){
              ...
              setTimeout(() => { 
                ...
                var oTable = $('#transactionTable').dataTable();
            oTable.fnDraw(false);
            swal("Success", "Transaksi berhasil didata", "success"); }, 1000);
            // console.log(data);
            }
        })
    })
