...
<head>
    ...
    <link
        ...
        <link rel="stylesheet" href="{{ asset('assets/vendor/libs/bootstrap-timepicker/css/bootstrap-timepicker.min.css') }}">
                ...
                <form action="{{route('booking.insert')}}" method="POST">
                    ...
                    <div class="row g-2">
                        <div class="col mb-0">
                            ...
                            <input type="text" id="merk_model" name="merk_model" required class="form-control"
                                placeholder="cth.Honda Vario" />
                        </div>
                        <div class="col mb-0">
...
<script>
    ...
    $('#wash_type').on('change', function() {
        ...
        var url = "{{ route('detail.pencucian', ':id') }}";
